...
#Script developed by Emmanuel Cano. This scripts gets the first 10 last malwaresites related to an IP address
#It is important to generate and paste your Umbrella Investigate Token into authorization field 
#In order to get more than 10 domains change the querystring limit
